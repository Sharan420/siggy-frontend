...
const Loader: React.FC<LoaderProps> = ({ className, splashText }) => {
  return (
    <div
      className={cn(
        "absolute z-10 flex flex-col items-center h-dvh md:h-screen w-screen bg-primary transition-all duration-150 opacity-100",
        className
      )}
    >
      <div className="flex flex-col justify-center h-full w-fit">
        <h1 className="text-white font-black italic text-[6rem] tracking-widest leading-[1em]">SIGGY</h1>
