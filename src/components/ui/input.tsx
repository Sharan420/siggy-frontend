    ...
    <div className={cn("flex flex-col", wrapperClassName)}>
      ...
      >
        {startAdornment && (
          <span
            className={cn(
              "px-3 pr-0 text-sm text-muted-foreground",
              startAdornmentClassName
            )}
          >
            {startAdornment}
        ...
        <input
          type={type}
          className={cn(
            "flex-1 px-3 py-2 placeholder:text-muted-foreground focus:outline-none disabled:opacity-50 rounded-r-sm bg-transparent",
            inputClassName
          )}
          ref={ref}
          {...props}
